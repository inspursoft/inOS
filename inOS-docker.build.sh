...
cp /var/lib/lxc/docker/rootfs/boot/vmlinuz-3.10.0-693.5.2.el7.x86_64 /boot/vmlinuz-3.10.0-inOS_docker
...
sed -i '$a\    linux /vmlinuz-3.10.0-inOS_docker ramdisk_size=4194304 quiet' /boot/grub2/grub.cfg
